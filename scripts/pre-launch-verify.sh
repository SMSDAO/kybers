...
echo -e "${BLUE}6. API Routes (Next.js)${NC}"
check "API routes directory" "[ -d frontend/app/api ]"
check "Health route" "[ -f frontend/app/api/health/route.ts ]"
check "Price route" "[ -d frontend/app/api/prices ]"
echo ""
